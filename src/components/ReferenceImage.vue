...
<template>
  ...
  <div v-else class="relative flex flex-col justify-center items-center gap-2">
    <div v-if="props.canDelete" class="w-6 h-6 bg-red-500 absolute top-0 right-0 rounded-full flex justify-center items-center" @click="emit('delete')">
